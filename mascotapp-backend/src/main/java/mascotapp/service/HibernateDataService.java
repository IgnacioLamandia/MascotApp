...
public class HibernateDataService {
	...
	public void createInitialData() throws IOException {
		...
		//gatos
		Post post1 = new Post("Gato encontrado", Encoder.encode(cats.get(0), "jpg"),
			-34.785178f,-58.200352f,"Berazategui",Category.ENCONTRADO);
		Post post2 = new Post("Gato perdido", Encoder.encode(cats.get(1), "jpg"),
			-34.785178f,-58.200352f, "Bernal",Category.PERDIDO);
		Post post3 = new Post("Gato busca familia", Encoder.encode(cats.get(2), "jpg"),
		...
		Post post5 = new Post("Fue encontrado en el centro de quilmes con collar gris", 
				Encoder.encode(dogs.get(1), "jpg"),-34.785178f,-58.200352f,"Quilmes",Category.ENCONTRADO);
		Post post6 = new Post("Perro perdido", Encoder.encode(dogs.get(2), "jpg"),
