...
export class CreatePostPage {
	...
	postProvider : PostProvider; 
  	...
  	constructor(private alrtCtrl:AlertController,public navCtrl: NavController, public navParams: NavParams, public restPosts: PostProvider) {
  	...
  	savePost(){
  	this.postProvider.newPost(this.post).subscribe(           
    () => {
